...
<style>
    ...
    #ciudad{
  padding: 10px 29.5px 9px 42.5px;
  border-radius: 8px;
  ...
  color: #ffffff;
  width: 365px;
  background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/magnifying-glass.png');
        background-repeat: no-repeat;
        background-size: auto;
        background-position: left;
    }
    #ciudad::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */
  color: #ffffff;
  opacity: 1; /* Firefox */
}

#ciudad:-ms-input-placeholder { /* Internet Explorer 10-11 */
  color: #ffffff;
}

#ciudad::-ms-input-placeholder { /* Microsoft Edge */
  color: #ffffff;
}
	...
	@media screen and (max-width: 1120px) {
		...
		.travelto-living__item{
			height: 120px;
			min-width: 130px;
			padding: 0;
		}

		.travelto-living__item__image svg{
			width: 30px;
		}

		.travelto-living__item__content{
			font-size: 14px;
			margin-top: 4px;
		}
	}
	...
	@media screen and (max-width: 1024px) {
		.travelto-info__content, .travelto-historia__content{
			display: flex;
			flex-direction: column-reverse;
		}
		.travelto-historia__right{
			margin-bottom: 40px;
		}
		.travelto-historia__left{
			margin-bottom: 0px;
		}
	}
		...
		<?php if ( have_rows( 'sliders' ) ) : ?>
			...
			<div class="autocomp"><input id="ciudad" placeholder="<?php _e('Busca la ciudad que quieres visitar','tuku') ?>"></div>
		<?php endif; ?>
        ...
        <div class="travelto-historia" id="historia">
            ...
            <div class="travelto-historia__content">
                ...
                <div class="travelto-historia__left">
                	<div class="desc-wrapper desc">
                    	<?php the_field( 'texto_b3' ); ?>
                    </div>    
                    <button class="more-info"><span class="more"><?php _e('mostrar más','tuku') ?> <span class="glyphicon glyphicon-chevron-down"></span></span><span class="less"><?php _e('mostrar menos','tuku') ?>  <span class="glyphicon glyphicon-chevron-up"></span></span></button>
                </div>
