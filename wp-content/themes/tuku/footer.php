          ...
          <div class="footer-top-wrapper">
            ...
            <div class="footer-collapse">
              <div class="footer-collapse-header">
                <h2><?php _e('Echa un vistazo','tuku') ?></h2>
                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.0625 11.5312L9 6.46875L3.9375 11.5313" stroke="#D81159" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span>
              </div>
	...
	'container_class' => '',
            ...
            <div class="footer-collapse">
              <div class="footer-collapse-header">
                <h2><?php _e('WhatsApp','tuku') ?></h2>
                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.0625 11.5312L9 6.46875L3.9375 11.5313" stroke="#D81159" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span>
              </div>
              <div class="footer-collapse-body">
                <div class="footer-collapse-link">
                  <?php _e('Agreganos y charlemos:','tuku') ?>
                </div>
                <?php wp_nav_menu( array( 
	...
	'container_class' => '',
            ...
            <div class="footer-collapse">
              <div class="footer-collapse-header">
                <h2><?php _e('Cuenta con nosotros','tuku') ?></h2>
                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.0625 11.5312L9 6.46875L3.9375 11.5313" stroke="#D81159" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span>
              </div>
        ...
        <div class="footer-container">
          <div class="footer-end-wrapper">
            <div class="footer-copy">
              ©<?php _e('Copyright © 2020 Tuku Travel, All rights reserved - Based in Lima Peru','tuku') ?>
            </div>
            <div class="footer-book">
              <a href="https://tukutravel.com/libro-de-reclamaciones/" target="__blank"> <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.06 4.04686C9.08415 3.1035 6.32243 2.64139 2.625 2.62499C2.2763 2.62025 1.93444 2.72193 1.645 2.91647C1.40743 3.07705 1.21296 3.29355 1.0787 3.54692C0.94443 3.80029 0.874481 4.08277 0.875003 4.36952V20.0156C0.875003 21.0733 1.6275 21.8712 2.625 21.8712C6.51164 21.8712 10.4103 22.2343 12.7455 24.4415C12.7774 24.4718 12.8176 24.4921 12.8609 24.4998C12.9043 24.5075 12.949 24.5023 12.9894 24.4848C13.0299 24.4673 13.0643 24.4383 13.0884 24.4015C13.1125 24.3646 13.1252 24.3215 13.125 24.2774V5.84171C13.1251 5.71732 13.0985 5.59437 13.047 5.48115C12.9955 5.36794 12.9202 5.2671 12.8264 5.18546C12.2915 4.72818 11.6974 4.34519 11.06 4.04686ZM26.355 2.91483C26.0654 2.72077 25.7236 2.61966 25.375 2.62499C21.6776 2.64139 18.9159 3.10131 16.94 4.04686C16.3027 4.34465 15.7084 4.72688 15.1731 5.18327C15.0794 5.26505 15.0044 5.36593 14.953 5.47912C14.9016 5.59232 14.875 5.7152 14.875 5.83952V24.2763C14.875 24.3186 14.8875 24.36 14.9109 24.3953C14.9343 24.4306 14.9676 24.4581 15.0066 24.4746C15.0456 24.491 15.0886 24.4955 15.1302 24.4876C15.1718 24.4796 15.2101 24.4596 15.2403 24.43C16.6441 23.0355 19.1078 21.8695 25.3772 21.8701C25.8413 21.8701 26.2864 21.6857 26.6146 21.3575C26.9428 21.0293 27.1272 20.5842 27.1272 20.1201V4.37006C27.1278 4.08275 27.0577 3.7997 26.9231 3.5459C26.7884 3.2921 26.5933 3.07537 26.355 2.91483Z" fill="#2C2C2C" fill-opacity="0.85"/>
</svg>
 <?php _e('Libro de reclamos','tuku') ?></a>
            </div>
          </div>
        </div>
      </div>
...
<div class="social-float">
 ...
            <a href="https://wa.me/+51940748076" class="social-float__item" target="_blank">
            ...
            <a href="https://www.linkedin.com/company/69374715/admin/" class="social-float__item" target="_blank">
             ...
             <a href="https://www.facebook.com/tukutravelperu" class="social-float__item" target="_blank">
...
<script>
    ...
    jQuery(document).ready(function() { 
		document.querySelector('.header__right__mail').addEventListener('click', () => {
			document.querySelector('.header__right__mail').classList.toggle('active');
		})
// 		footer
// 		
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            ...
            if (footerCollapses) {
              Array.from(footerCollapses).map((item, index) => {
                item
                  .querySelector(".footer-collapse-header")
        ...
        // foot Sponsors
	    var homeSponsors = new Swiper('.foot-sponsors--slider', {
		slidesPerView: 5,
		slidesPerGroup: 1,
		spaceBetween: 40,
		loop: true,
...
<script type="text/javascript">(function () {
    ...
    ldk.async = true;
    ldk.src = 'https://s.cliengo.com/weboptimizer/618324aed8aec0002af543d6/6267398e1e41de002a841b58.js?platform=onboarding_modular';
