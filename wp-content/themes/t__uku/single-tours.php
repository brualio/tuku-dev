    ...
    <div class="container tabs__content">
        ...
        <?php if ( have_rows( 'summary' ) ) : $s;?>
            <div id="itinerary" class="itinerario__wrap">
                <h1><?php _e('Resumen de itinerario') ?></h3>
        ...
        <div class="container">
            ...
            <div class="wrap__comentarios">
                ...
                <div class="wrap__show">
                    <a class="btn" id="gallery-load-more" href="javascript: my_repeater_show_more();" <?php if ($total < $count) { ?> style="display: none;"<?php } ?>><?php _e('show more','tuku') ?></a>
